	        ...
	        <div class="my-3 my-md-5">
	          	<div class="container">
	            	...
	            	<table>  <!-- class="table responsive table-striped table-sm table-dark" -->
					  ...
					  <tbody>
					    <?php
					    $blank = mysqli_query($conn, "
					    	SELECT * FROM `tbl_class_member` cm LEFT JOIN tbl_student s ON cm.`student_id` = s.`student_id` WHERE cm.`class_id` =".$_GET['id']);
