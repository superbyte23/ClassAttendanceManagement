    ...
    <div class="page">
        ...
        <?php require 'include/topbar.php'; ?> 
	        <div class="my-3 my-md-5">
	          	<div class="container">
	            	<button class="btn btn-success" data-toggle="modal" data-target="#add_class" style="margin-top: -15px; margin-bottom: 10px; box-shadow: 5px 5px 10px grey;"> Add Class</button>
	            	<table class="table table-dark table-sm table-striped">
					  ...
					  <tbody>
					    <?php 
					    	$query = mysqli_query($conn, "SELECT * FROM `tbl_class` ORDER BY `class_schedule` ");
